...
class PluginExamplepluginProfile extends CommonDBTM
{
    ...
    static function canCreate(): bool
    {
        if (isset($_SESSION['profile'])) {
            return $_SESSION['profile']['exampleplugin'] == 'w';
        } else {
            return false;
        }
    }
    ...
    {
        if (isset($_SESSION['profile'])) {
            return $_SESSION['profile']['exampleplugin'] == 'r' || $_SESSION['profile']['exampleplugin'] == 'w';
        } else {
            return false;
        }
    }
    ...
    static function getRightsGeneral()
    {
        $rights = [
            [
                ...
                'label'     => __('Use exampleplugin', 'exampleplugin'),
                'field'     => 'plugin_exampleplugin_exampleplugin',
                'rights'    =>  [UPDATE    => __('Allow editing', 'exampleplugin')],
                'default'   => 23
            ]
        ];
        return $rights;
