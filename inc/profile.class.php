...
class PluginExamplepluginProfile extends CommonDBTM {
	...
	static function canCreate() {
		if (isset($_SESSION["profile"])) return ($_SESSION["profile"]['exampleplugin'] == 'w');
		return false;
	}
	...
	static function canView() {
		if (isset($_SESSION["profile"])) return ($_SESSION["profile"]['exampleplugin'] == 'w' || $_SESSION["profile"]['exampleplugin'] == 'r');
		return false;
	}
